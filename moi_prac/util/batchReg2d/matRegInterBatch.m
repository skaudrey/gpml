function [u0,u1,consum,inter,hyp] = matRegInterBatch(file_pre,minlon,minlat,maxlon,maxlat,typeV,epoch,samp,sub_row,sub_col)
resolution = 0.125;
...
for i = 1:size_reg
    ...
    [predict_temp,hyp_temp,consum_temp,inter_temp] = mat(epoch,sub_xtrain,sub_ytrain,sub_xtest);
...
function [predict,hyp,consum,inter] = mat(epoch,x_train,y_train,x_test)
% 2a) define the kernel functions 
size_hyp_2 = 2;% the size of hyperparameters for method2: multi-scale
covfunc2 = {@covMaterniso,3};
inf  = @infGaussLik;
