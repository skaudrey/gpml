...
function [u0 u1  consum inter hyp] = reg_mp_pca_prodBatch(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV,epoch,samp,sub_row,sub_col)
resolution = 0.125;
close all
...
for i = 1:size_reg
    ...
    [predict_temp,hyp_temp,consum_temp,inter_temp] = mp_pca_prod(epoch,sub_xtrain,sub_pcaytrain,sub_ytrain,sub_xtest);
...
function [predict,hyp,consum,inter] = mp_pca_prod(epoch,sx_train,sypca_train,sy_train,sx_test)
% a) define the kernel functions 
size_hyp_4_p = 10 ;
size_hyp_4_s = 10 ; 
covfunc4_pca = {'covSum',{{@covMaternard,1}, {'covPERard',{@covMaternard,1}} }};
covfunc4_s = {'covSum',{{@covMaternard,1}, {'covPERard',{@covMaternard,1}} }};
