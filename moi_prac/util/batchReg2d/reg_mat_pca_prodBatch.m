...
function [u0 u1  consum inter hyp] = reg_mat_pca_prodBatch(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV,epoch,samp,sub_row,sub_col)
resolution = 0.125;
close all
...
for i = 1:size_reg
    ...
    [predict_temp,hyp_temp,consum_temp,inter_temp] = mat_pca_prod(epoch,sub_xtrain,sub_pcaytrain,sub_ytrain,sub_xtest);
...
function [predict,hyp,consum,inter] = mat_pca_prod(epoch,sx_train,sypca_train,sy_train,sx_test)
