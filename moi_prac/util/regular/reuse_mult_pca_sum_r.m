%% Interpolation
function [u0,u1,consum,inter,ys,sx_test,sy_test,sx_train,sy_train] = reuse_mult_pca_sum_r(prefix_s,minlon,minlat,maxlon,maxlat,typeV,samp,stamp,hyp)
resolution = 0.125;
...
% interpolate
[u1_temp,consum,inter,ys] = mpng_pca_sum(sx_train,sy_train,sx_test,hyp);
...
%% inter function
function [predict,consum,inter,ys] = mpng_pca_sum(sx_train,sy_train,sx_test,hyp)
