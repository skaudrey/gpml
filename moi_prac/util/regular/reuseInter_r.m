function [u0,u1,v0,v1,s0,s1,d0,d1,consum,inter,ysu,ysv,x_test,y_test,x_train,y_train] = reuseInter_r(typeS,typeI,typeD,typeM,path,minlon,minlat,maxlon,maxlat,epoch,samp,stamp,hypu,hypv)
%% global variables
...
switch(typeM)
    case 1 %pcareg_m_prod
        [u0 u1 consum1 inter1 ysu x_testu y_testu x_trainu y_trainu] = reuse_mult_pca_prod_r(prefix_s,minlon,minlat,maxlon,maxlat,typeV(1),samp,stamp,hypu);
        [v0 v1 consum2 inter2 ysv x_testv y_testv x_trainv y_trainv] = reuse_mult_pca_prod_r(prefix_s,minlon,minlat,maxlon,maxlat,typeV(2),samp,stamp,hypv);
