...
%need to be saved
u_temp = []; v_temp = []; su_temp = []; sv = []; train_time = []; inter_time = []; rmse = {}; ysu = {};   ysv = {};
        ...
        for epoch_index = 1:epoch_size
            ...
            for typeM = m0:m1   % see function regionName
                ...
                [u0 u1 v0 v1 s0 s1 d0 d1 consum inter ysut ysvt xtemp ytemp xtrmp ytrmp] = ...
                    reuseInter_r(typeS,typeI,typeD,typeM,path,minlon,minlat,maxlon,maxlat,ep,samp,stamp,hypu,hypv);
...
%         region = regionName(0,typeI,0,typeD,minlon,maxlon,minlat,maxlat);        
        filename = strcat(path,'Inter_seagull_reuse_p_r','.mat');    
