...
function [u0 u1  u2] = mpV(prefix_t,prefix_p,prefix_d,prefix_s,lon)
...
size_hyp_4_p = 5 ; %the size of hyperparameters for method4_pressure: multi
size_hyp_4_t = 5 ; %the size of hyperparameters for method4_temperature: multi
size_hyp_4_d = 5 ; %the size of hyperparameters for method3_direction: only materniso,1
size_hyp_4_s = 5 ; %the size of hyperparameters for method3_space: only materniso,1
...
covfunc4_pres = {'covSum',{{@covMaterniso,1},'covPeriodic'}};
covfunc4_temp = {'covSum',{{@covMaterniso,1},'covPeriodic'}};
...
hyp4.lik = log(exp(hyp4_d.lik) * exp(hyp4_s.lik) *((1/2) * hyp4_t.lik + (1/2)* hyp4_p.lik)) ;
