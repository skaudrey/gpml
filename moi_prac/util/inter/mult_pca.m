...
function [u0 u1  u2] = mult_pca(prefix_p,prefix_s,lon)
...
size_hyp_4_s = 13 ; %the size of hyperparameters for multi-scale for space data/time data
...
covfunc4_pca = {'covSum',{{@covMaterniso,3},{'covProd',{{@covMaterniso,3},'covPeriodic'}},{ 'covRQard' },{'covSum',{{@covMaterniso,3},'covNoise'}}}};
