...
function [u0 u1  consum inter hyp] = reg_mult_pcamat_prod(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV,epoch,samp)
resolution = 0.125;
...
size_lat =  abs(maxlat-minlat)/resolution+1;
size_lon =  abs(maxlon-minlon)/resolution+1;
