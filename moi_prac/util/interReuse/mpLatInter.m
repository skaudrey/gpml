function [u0,u1,v0,v1,s0,s1,d0,d1,consum,inter,hyp] = mpLatInter(typeS,typeI,typeD,typeM,path,minlon,minlat,maxlon,maxlat,epoch,samp,stamp)
%% global variables
...
switch(typeM)
    case 1 %pcareg_m_prod
        [u0 u1 consum1 inter1 hypu] = time_mp_pca_sum(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV(1),epoch,samp,stamp);
        [v0 v1 consum2 inter2 hypv] = time_mp_pca_sum(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV(2),epoch,samp,stamp);
