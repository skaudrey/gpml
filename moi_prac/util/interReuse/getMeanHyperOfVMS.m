...
%dimension mult
function [hypu,hypv] = getMeanHyperOfVMS(tID,mType)  
...
f_space = 'Inter_vms_space.mat';
f_time = 'Inter_vms_time.mat';
f_space_all = 'Inter_vms_all_space.mat';
f_time_all = 'Inter_vms_all_time.mat';
train_size = 0;
s = {};
switch(tID)
    case 1
