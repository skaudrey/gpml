function [u0 u1  consum inter hyp] =  time_m_pca_sum(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV,epoch,samp,stamp)
resolution = 0.125;
...
size_hyp_4_p = 3 ; %the size of hyperparameters for multi-scale method of pca feature: multi

size_hyp_4_s = 3 ; %the size of hyperparameters for multi-scale for space data/time data
...
covfunc4_pca = {'covSum',{@covMaternard,1}};
covfunc4_s =  {'covSum',{@covMaternard,1}};
