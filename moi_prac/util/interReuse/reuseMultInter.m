function [u0,u1,v0,v1,s0,s1,d0,d1,lat,lon,consum,inter] = reuseMultInter(typeS,typeI,typeD,typeM,path,minlon,minlat,maxlon,maxlat,samp,stamp,hypu,hypv)
%% global variables
...
switch(typeM)
    case 1 %pcareg_m_prod
        [u0 u1 x_lat x_lon consum1 inter1 ] = reuse_mult(prefix_s,minlon,minlat,maxlon,maxlat,typeV(1),samp,stamp,hypu);
        [v0 v1 x_lat x_lon consum2 inter2] = reuse_mult(prefix_s,minlon,minlat,maxlon,maxlat,typeV(2),samp,stamp,hypv);
