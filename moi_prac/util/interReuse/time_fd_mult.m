function [u0,u1,consum,inter hyp] = time_fd_mult(file_pre,minlon,minlat,maxlon,maxlat,typeV,epoch,samp,stamp)
resolution = 0.125;
...
size_hyp_2 = 27;% the size of hyperparameters for method2: multi-scale
