...
switch(typeM)
    case 1 %pcareg_m_prod
        [u0 u1 x_lat x_lon  consum1 inter1 hypu] = time_mult_pca_sum(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV(1),epoch,samp,stamp);
        [v0 v1 x_lat x_lon  consum2 inter2 hypv] = time_mult_pca_sum(prefix_p,prefix_s,minlon,minlat,maxlon,maxlat,typeV(2),epoch,samp,stamp);
