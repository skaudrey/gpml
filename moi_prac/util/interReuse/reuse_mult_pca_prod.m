%% Interpolation
function [u0,u1,lat,lon,consum,inter] = reuse_mult_pca_prod(prefix_s,minlon,minlat,maxlon,maxlat,typeV,samp,stamp,hyp)
resolution = 0.125;
...
% interpolate
[u1_temp,consum,inter] = mult_pca_prod(sx_train,sy_train,sx_test,hyp);
...
%% inter function
function [predict,consum,inter] = mult_pca_prod(sx_train,sy_train,sx_test,hyp)
