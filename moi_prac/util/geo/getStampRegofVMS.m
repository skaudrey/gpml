...
function [minlon,maxlon,minlat,maxlat,stamp] = getStampRegofVMS(stIndex,dataType,batchIndex)
stamp = 0;
...
%         stamp = stIndex+1;
   ...
   case 2  %1-40   time all, stamp 2-81; region 0-10'E, 2' longitude per subregion, feature smds
        ...
        minlat = 0; maxlat = 60;
        stamp = stIndex;
    case 3  %1-30   %region all, stamp 4-15; region 120'E-180'E, 2' longitude per subregion, feature smd
