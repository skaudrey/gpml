...
% =start===================Skaudrey: 17/09/24============================
% additive function is one which decompose into a sum of low-dimensional
% functions,each depending on only a subset of the input variables.
% Additive GPs generalize both Generalized Additive Models,and the standard
% GP models which use squared-exponential kernels.Hyperparameter learning
% in this model can be seen as Bayesian Hierarchical Kernel Learning.
% =end===================Skaudrey: 17/09/24============================
